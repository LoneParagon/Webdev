        ...
        <nav class="nav">
          ...
          <div class="nav__menu">
            ...
            <ul class="nav__list">
              ...
              <li class="nav__item">
                <a href="#category" class="nav__link scroll-link">Products</a>
              </li>
              <li class="nav__item">
        ...
        <div class="glide__track" data-glide-el="track">
          <ul class="glide__slides">
            <li class="glide__slide">
              <div class="hero__center">
                <div class="hero__left">
                  <span class="">Smartphone of 2021</span>
                  <h1 class="">PHONE JUST FOR YOU!</h1>
                  <p>You will be surprised by its features</p>
                  <a href="#"><button class="hero__btn">BUY IT</button></a>
                </div>
            ...
            <li class="glide__slide">
              <div class="hero__center">
                <div class="hero__left">
                  <span>Laptop of 2021</span>
                  <h1>You will not find anything better!</h1>
                  <p>It has everything you need</p>
      ...
      <div class="container">
        <div class="newsletter__content">
          <div class="newsletter__data">
            ...
            <p>Probably you will get some coupons. Who knows?</p>
          </div>
          <form action="php/subscribe.php" method="post">
            <input type="email" placeholder="Enter your email address" class="newsletter__email" name="subscribe_btn">
            <input type="submit" class="newsletter__link" href="" value="Subscribe"></input>
          </form>
        </div>
      </div>
    </section>
